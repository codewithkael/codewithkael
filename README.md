...
- 💼 5+ years of Android Development with Java & Kotlin
...
<p align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=codewithkael&theme=tokyonight&no-frame=true&row=1&column=6"/>
</p>
...
|--------|-------------|------|
| 🎥 [WebRTC Android](https://github.com/codewithkael) | Production-ready video calling & conferencing | WebRTC, Kotlin, Ktor |
| 👁️ [Parent-eye.com](https://parent-eye.com) | Real-time child monitoring platform | WebRTC, Android, Cloud |
| 🤖 ML Kit + WebRTC | Face detection integrated with live video | ML Kit, CameraX, Kotlin |
| 📡 Real-Time Chat | WebSocket-based messaging with STUN/TURN | Ktor, Coroutines |
...
<p align="center">
  <i>"Building the future of real-time communication, one commit at a time."</i> 🚀
</p>
